...
trait LocalizationTrait {
  ...
  /**
   * Injects localization factory.
   *
   * @var \TYPO3\CMS\Core\Localization\LocalizationFactory The localization factory
   * @noinspection PhpUnnecessaryFullyQualifiedNameInspection
   */
  ...
  protected function getLocalizations(string $languageKey = 'default'): array {
    $locallang = ExtensionManagementUtility::extPath(self::EXTENSION_KEY, 'Resources/Private/Language/locallang.xlf');
